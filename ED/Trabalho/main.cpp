...
#include "estaticaSequencial/lista.h"
#include <string.h>
#include <stdlib.h>
#include <stdio.h>

int main(){
    int op, matricula, res, ord;
    Lista L1;
    Lista L2;
    Lista L3;
    Aluno v;
  ...
  do {
      ...
      printf("14-Intercalar duas listas, L1 e L2, gerando uma lista L3. Considere que L1, L2 e L3 estão ordenadas;\n");
      printf("15-Sair\n");
