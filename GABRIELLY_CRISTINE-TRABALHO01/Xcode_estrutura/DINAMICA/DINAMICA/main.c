    ...
    if (!fp) {
        ...
        while(!feof(fp) ) {
            while (op != 15){
                ...
                printf("14-Intercalar duas listas, L1 e L2, gerando uma lista L3. Considere que L1, L2 e L3 estao ordenadas\n");
                printf("15-Sair\n");
                ...
                switch(op){
                    case 1:
                        ...
                        fprintf(fp, "%s %d %.2f %.2f %.2f\n",v.nome, v.matricula, v.nota1, v.nota2, v.nota3);
                        break;
